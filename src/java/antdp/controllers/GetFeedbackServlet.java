...
public class GetFeedbackServlet extends HttpServlet {
    ...
    private final Logger LOGGER = Logger.getLogger(GetFeedbackServlet.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<RatingDTO> list = dAO.getAllFeedbackByCarID(carID);
            float point = dAO.getRatingCar(carID);
            request.setAttribute("LISTRATING", list);
