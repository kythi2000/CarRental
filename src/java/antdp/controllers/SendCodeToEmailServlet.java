...
import antdp.utilities.VerifyEmail;
 ...
 * @author HP 840 G2
 */
@WebServlet(name = "SendCodeToEmailServlet", urlPatterns = {"/SendCodeToEmailServlet"})
public class SendCodeToEmailServlet extends HttpServlet {
    
    private static final Logger LOGGER = Logger.getLogger(SendCodeToEmailServlet.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            VerifyEmail.sendCodeToEmail(email, verifyCode);
        } catch (Exception e) {
